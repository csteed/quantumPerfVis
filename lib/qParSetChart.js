var pcpChart = function () {
    ...
    const supplementRectangleSize = 14;
    const supplementRectanglePad = 4;
    const supplementRectangleLabelHeight = 10;
    ...
    const drag = d3.drag()
        ...
        .on("end", function(d) {
            ...
            let srcIndex = dimensions.findIndex(function(dim) {
                console.log(dim.name + " = " + draggingDimName);
    ...
    function chart(selection, data) {
        ...
        probabilityColorScale = d3.scaleSequential(d3.interpolateGreys).domain([0, 1]);
